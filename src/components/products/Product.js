...
import { GetAPIWCookie, GetAPINotToken } from "../../api/RestAPIs";
...
function Product({ prodCode }) {
    ...
    useEffect(() => {
        ...
        const similarProducts = async () => {
            ...
            const curationProductsAddress = `/curation?curationAge=${product.prodAge}&curationIngra=${ingra}&curationDisease=${disease}&curationAllergy=&curationCook=${product.prodCook}&curationSize=${product.prodSize}`;
