    ...
    return(
        <div className={styles.container}>
            <div className={styles.textBox}>
                <p className={styles.text1}>이용약관</p><br/>
            ...
            <div className={styles.textBox2}>
                <span className={styles.terms}>제1조(목적) <br/>
...
③ “독식”은 이용자의 개인정보를 수집·이용하는 때에는 당해 이용자에게 그 목적을 고지하고 동의를 받습니다.<br/><br/>
...
제12조(이용자의 의무) 이용자는 다음 행위를 하여서는 안 됩니다.<br/>
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.</span>
            </div>
        </div>
    )
}
